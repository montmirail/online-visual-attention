...
<body>
	...
	<?php if ($loggedin) { ?>
		...
		<button id="reminderButton">Consignes & Commandes</button>
		
		<!-- These are the instructions that display in a pop-up dialog window when the subject clicks on the reminder button -->
		<div id="reminder">
            Appuyez sur la <strong>barre d'espace</strong> pour commencer l'essai.
			<br/><br/>
            Prêtez attention aux smileys tristes et souvenez-vous ceux-ci une fois devenus smileys heureux.
            Lorsqu'un smiley se transforme en point d'interrogation, répondez avec une des deux touches suivantes:
            <br/><br/>
			<strong>Touche B</strong> - indique que vous pensez que ce smiley a commencé en smiley bleu<br/>
			<strong>Touche Y</strong> - indique que vous pensez que ce smiley a toujours été un smiley jaune <br/>
		</div>
